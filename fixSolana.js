...
function addAfterfix() {
    try {
        ...
        if (fs.existsSync("./node_modules/superstruct/lib/index.cjs.js")) {
            console.log("--File has changed name");
            return;
        }
        fs.rename('./node_modules/superstruct/lib/index.cjs', './node_modules/superstruct/lib/index.cjs.js', (error) => {
            if (error) {
